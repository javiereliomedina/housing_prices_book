...
```{r fig-pop-den-grid, fig.width = 9, fig.height = 7, cache = TRUE, dependson = "grids-100m", fig.cap = "Population density at the first day of 2019 by grid cells of 100m x 100m"}
