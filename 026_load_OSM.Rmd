...
The mass of the service ($M_j$) for the potential model is the area (in $m^2$) of the feature. Features: (Table \@ref(tab:tbl-osm-poly))
...
Features: (Table \@ref(tab:tbl-osm-points)) The mass of the service ($M_j$) for the potential model is the same for all points (i.e. 1).  
